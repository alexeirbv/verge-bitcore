...
var PROTOCOL_VERSION = 70003 //Вот этот параметр по инструкции надо увеличить на 3;
  ...
  try {
    switch (message.command) {
      case 'version':
        ...
        console.log('PROTO_VERSION: '+message.version);
...
Connection.prototype.processData = function() {
  ...
  if (message) {
    console.log('PROTOCOL_VERSION '+message.version);
